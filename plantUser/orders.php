    ...
    <div class="container p-5 d-flex flex-column">
        ...
        <div class=" d-flex flex-column py-3">
            <div class="sh1 d-flex align-items-center justify-content-between px-5 py-1 my-4">
                <span class="fw-bolder fs-4">S.no.</span>
                <span class="fw-bolder fs-4">Order ID</span>
                <span class="fw-bolder fs-4">Date</span>
                <span class="fw-bolder fs-4">Amount</span>
                <span class="fw-bolder fs-4">Status</span>
            </div>

            <?php
            $sql1 = "SELECT * FROM orders Where buyerId='$emailId' ";
